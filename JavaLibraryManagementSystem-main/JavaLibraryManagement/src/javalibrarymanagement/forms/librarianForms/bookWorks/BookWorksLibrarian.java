...
import javalibrarymanagement.forms.memberForms.*;
...
public class BookWorksLibrarian extends javax.swing.JFrame {
    ...
    public BookWorksLibrarian(Librarian librarian) {
        initComponents();
        CenterScreen.centerScreen(this);
        currentLibrarian = librarian;
        txtWelcome.setText(currentLibrarian.getLibrarianName());
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(28, 138, 969, 610);
        ...
        etCategory.setBounds(1010, 340, 223, 40);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(1010, 220, 42, 22);

        jLabel3.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jLabel3.setText("Category");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(1010, 310, 80, 22);
        ...
        jPanel1.add(etName);
        etName.setBounds(1010, 250, 223, 40);
        ...
        etAuthor.setBounds(1010, 430, 223, 40);

        jLabel4.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jLabel4.setText("Author");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(1010, 400, 46, 22);
        ...
        etPublisher.setBounds(1010, 520, 223, 40);

        jLabel7.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jLabel7.setText("Publisher");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(1010, 490, 90, 22);
        ...
        btnUpdate.setBounds(1010, 700, 223, 50);
        ...
        jPanel1.add(btnAdd);
        btnAdd.setBounds(1010, 580, 223, 50);
        ...
        btnDelete.setBounds(1010, 640, 223, 50);

        jPanel2.add(jPanel1);
        jPanel1.setBounds(230, 0, 1270, 770);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(selectedRow!=-1){
            if(service.deleteBook(tblBooks.getValueAt(selectedRow, 0).toString())){
                model.setRowCount(0);
                addBooksToTable(service.getAllBooks());
                JOptionPane.showMessageDialog(this, "Book Deleted", "Success",JOptionPane.INFORMATION_MESSAGE);
                
            }else{
                JOptionPane.showMessageDialog(this, "This book are borrowed", "Error",JOptionPane.ERROR_MESSAGE);
            }
        }else{
            JOptionPane.showMessageDialog(this, "Please select a book in table", "Error",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        int selectedRow = tblBooks.getSelectedRow();
        if(selectedRow!=-1){
            ArrayList<Book> book = service.searchWithISBN(tblBooks.getValueAt(selectedRow, 0).toString());
            new UpdateBookLibrarian(currentLibrarian,book.get(0)).setVisible(true);
            this.setVisible(false);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Please select a book in table", "Error",JOptionPane.ERROR_MESSAGE);
