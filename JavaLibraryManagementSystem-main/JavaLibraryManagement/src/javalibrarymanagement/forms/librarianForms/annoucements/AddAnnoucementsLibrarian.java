...
public class AddAnnoucementsLibrarian extends javax.swing.JFrame {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        Annoucement annoucement = new Annoucement(0,  etName.getText(), etDesc.getText(), sdf.format(etDate.getDate()), currentLibrarian.getLibrarianID());
        if(!service.addAnnoucements(annoucement, currentLibrarian.getLibrarianID())){
            JOptionPane.showMessageDialog(this, "Annoucement added", "Success",JOptionPane.INFORMATION_MESSAGE);
            new AnnoucementsLibrarian(currentLibrarian).setVisible(true);
            this.setVisible(false);
            this.dispose();
        }else{
