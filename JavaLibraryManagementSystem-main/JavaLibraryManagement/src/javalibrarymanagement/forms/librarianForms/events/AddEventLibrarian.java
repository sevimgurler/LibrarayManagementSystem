...
import javalibrarymanagement.forms.librarianForms.bookWorks.*;
...
public class AddEventLibrarian extends javax.swing.JFrame {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        Event event = new Event(0, etType.getText(), sdf.format(etDate.getDate()), etName.getText(), etDesc.getText(), currentLibrarian.getLibrarianID());
        if(!service.addEvent(event, String.valueOf(currentLibrarian.getLibrarianID()))){
            JOptionPane.showMessageDialog(this, "Event added", "Success",JOptionPane.INFORMATION_MESSAGE);
            new EventsLibrarian(currentLibrarian).setVisible(true);
            this.setVisible(false);
            this.dispose();
        }else{
