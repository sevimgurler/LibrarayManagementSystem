...
public class UpdateEventLibrarian extends javax.swing.JFrame {
    ...
    public UpdateEventLibrarian(Librarian librarian, Event event) {
        initComponents();
        CenterScreen.centerScreen(this);
        currentLibrarian = librarian;
        selectedEvent = event;        
        etDesc.setText(event.getEventDesc());
        etName.setText(event.getEventName());
        etType.setText(event.getEventType());
        try {
            etDate.setDate(sdf.parse(event.getEventDate()));
        } catch (ParseException ex) {
            Logger.getLogger(UpdateEventLibrarian.class.getName()).log(Level.SEVERE, null, ex);
        }   
    }
    ...
    private void initComponents() {
        ...
        etType.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(etType, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        Event event = new Event(selectedEvent.getEventID(), etType.getText(), sdf.format(etDate.getDate()), etName.getText(), etDesc.getText(), currentLibrarian.getLibrarianID());
